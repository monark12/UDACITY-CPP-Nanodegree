...
bool RoutePlanner::Compare(const RouteModel::Node * neighbour1, const RouteModel::Node * neighbour2) {
  return neighbour1->g_value + neighbour1->h_value > neighbour2->g_value + neighbour2->h_value; 
}
